...
const COMPONENT_LIST = [
	...
	},
	{
		...
		testConfig: '{x: 0, points: [0, 0, 100, 100], pointerLength: 20, pointerWidth: 20, strokeWidth: 10, stroke: "black"}'
	},
	{
		componentName: 'Shape',
		example:
...
const SVELTE_KONVA_COMPONENT_TEST_ACTION_LIST = COMPONENT_LIST.filter((data) => data.testConfig).map((data) => {
	return {
		type: "add",
		force: true,
